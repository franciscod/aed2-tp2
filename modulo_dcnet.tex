...
\begin{enumerate}
	...
	\item Las claves de diccPaquetes son los id de los paquetes en
		conjPaquetes 
	\item Los significados de diccPaquetes contienen un itConj que apunta al
		...
		encuentra
	\item Si colaPaquetes no es vacía, su próximo es un paqueteDCNet que
